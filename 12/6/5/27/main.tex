...
\fi
    ...
    \begin{enumerate}
        ...
        \item $\lambda = 1$. In this case, \eqref{eq:12/6/5/27/lagmul} becomes
        \begin{align}
            \myvec{0&0\\0&1}\vec{x} &= \myvec{0\\4} \\
            \implies \vec{e_2}^\top\vec{x} = 4
            \label{eq:12/6/5/27/x-e2}
        \end{align}
        Substituting \eqref{eq:12/6/5/27/x-e2} into \eqref{eq:12/6/5/27/constr} becomes
        \begin{align}
            \brak{\vec{e_1}^\top\vec{x}}^2 &= 8 \\
            \implies \vec{e_1}^\top\vec{x} &= \pm 2\sqrt{2}
            \label{eq:12/6/5/27/x-e1}
        \end{align}
        Using \eqref{eq:12/6/5/27/x-e1} and \eqref{eq:12/6/5/27/x-e2},
        \begin{align}
